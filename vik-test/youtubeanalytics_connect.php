...
$youtube = new Api\YouTubeAnalytics($client);
...
if ($client->getAccessToken()) {
    ...
    try {
        ...
        $videos = $youtube->reports->query("UC55IWqFLDH1Xp7iu1_xknRA","2013-03-01","2013-03-31","views,comments,favoritesAdded,likes,dislikes,estimatedMinutesWatched,averageViewDuration");
        echo "<pre>";
        print_r($videos);
        exit;
        /**
