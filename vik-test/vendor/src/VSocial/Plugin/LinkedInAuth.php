...
use VSocial\OAuth\SignatureMethod\Hmacsha1 as OAuthSignatureMethod_HMAC_SHA1;
...
class LinkedInAuth {
    ...
    public $http_code;
    public $url;
    public $host = "https://api.linkedin.com/v1/people/";
    public $timeout = 30;
    ...
    public $http_info;
    public $useragent = 'LinkedInAuth v0.1.1';
    public $consumer;
    public $token;
    public $sha1_method;
...
//    protected function process_xml (SimpleXMLIterator $xml) {
//        
//    }
