...
class HttpRequest {
    ...
    public function __construct ($url, $method = 'GET', $headers = array(), $postBody = null) {
        ...
        $this->apiConfig = \VSocial\Utils\Storage::get("config");

        if (empty($this->apiConfig['application_name'])) {
            $this->userAgent = self::USER_AGENT_SUFFIX;
        } else {
            $this->userAgent = $this->apiConfig['application_name'] . " " . self::USER_AGENT_SUFFIX;
        }
    }
    ...
    public function setUrl ($url) {
        if (substr($url, 0, 4) == 'http') {
            ...
            $this->url = $this->apiConfig['basePath'] . $url;
        }
    }
