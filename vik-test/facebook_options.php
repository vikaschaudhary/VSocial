...
$fb_options = array(
    "users" => array(
        array("url" => "users/profile_image", "method" => "GET",),
        array("url" => "users/follows", "method" => "GET",),
        array("url" => "users/likes", "method" => "GET",),
    ),
);
?>
<?php
...
<?php foreach ($options_uris as $opt): ?>
        <li>
            <a class="<?= $opt['method'] ?>" target="_blank" href="http://10.2.2.82/vik-test/public/index.php?service=facebook/<?= $opt['url'] ?>"><?= $opt['title'] ?></a>    
        </li>
<?php endforeach; ?>
</ol>
<style type="text/css">
