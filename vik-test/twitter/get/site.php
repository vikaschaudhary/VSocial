 ...
 * GET site
 * 
 * @desc Streams messages for a set of users
 * @Overview Site Streams allows services, such as web sites or mobile push services, to 
 * receive real-time updates for a large number of users. Events may be streamed for any 
 * user who has granted OAuth access to your application. Desktop applications or 
 * applications with few users should use user streams 
 * 
...
$search = $twitter->get("site", $params);
print_r($search);
?>