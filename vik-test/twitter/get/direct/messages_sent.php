 ...
 * 
 * @desc Returns the 20 most recent direct messages sent by the authenticating user. 
 * Includes detailed information about the sender and recipient user. You can request 
 * up to 200 direct messages per call, up to a maximum of 800 outgoing DMs.
